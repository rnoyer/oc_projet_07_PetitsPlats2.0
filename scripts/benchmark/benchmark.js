...
function fonctionnelGetFilteredRecipeArray(recipeList = [], searchbar = '', ingredients = emptyList, appliances = emptyList, ustensils = emptyList) {
    ...
    if(ingredients.Ingredient.length){
        ...
        FilteredRecipes.forEach(recipe => {
            ...
            let testIntersection = recipeIngredients.filter(item => ingredients.Ingredient.includes(item)).length
    ...
    if(ustensils.Ustensil.length){
        ...
        FilteredRecipes.forEach(recipe => {
            ...
            // Return TRUE if intersection exist
            let testIntersection = recipe.ustensils.filter(item => ustensils.Ustensil.includes(item.toLowerCase())).length
...
const SearchBarInput = 'tarte'

const ingredientListsOfCheckedElements = {
    "Ingredient": [
        "sucre",
        "oeuf"
    ],
...
const applianceListsOfCheckedElements = {
    "Ingredient": [],
    "Appliance": [
        "casserole"
    ],
...
const ustensilListsOfCheckedElements = {
    "Ingredient": [],
    "Appliance": [],
    "Ustensil": [
        "saladier",
...
fonctionnelGetFilteredRecipeArray(recipes,'',ingredientListsOfCheckedElements,emptyList,emptyList)
fonctionnelGetFilteredRecipeArray(recipes,'',emptyList,applianceListsOfCheckedElements,emptyList)
...
natifGetFilteredRecipeArray(recipes,'',ingredientListsOfCheckedElements,emptyList,emptyList)
natifGetFilteredRecipeArray(recipes,'',emptyList,applianceListsOfCheckedElements,emptyList)
natifGetFilteredRecipeArray(recipes,'',emptyList,emptyList,ustensilListsOfCheckedElements)